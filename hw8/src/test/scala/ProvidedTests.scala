class ProvidedTests extends org.scalatest.FunSuite {
  ...
  //MY TESTS
  test("test leap years with years"){
    val date1 = LocalDate.of(2016, 2, 29) + 5.years
    assert(date1 == LocalDate.of(2021, 2, 28))
  }

  test("test leap years with days"){
    val date1 = LocalDate.of(2020, 2, 28) + 2.days
    assert(date1 == LocalDate.of(2020, 3, 1))
  }

  test("test leap years with months"){
    val date1 = LocalDate.of(2020, 1, 30) + 1.months
    assert(date1 == LocalDate.of(2020, 2, 29))
  }
}
